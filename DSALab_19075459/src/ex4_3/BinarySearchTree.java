   ...
   implements SortedSet<E>
{
   ...
   public void rightRotationOfRoot() {
       ...
       BinaryTreeNode newRoot = oldRoot.leftChild;
       BinaryTreeNode rightAscendant = newRoot.rightChild;
       
       //sever the links
       oldRoot.leftChild = null;
       newRoot.rightChild = null;
       
       //rotate to right (re-connect the links)
       rootNode = newRoot;
       oldRoot.leftChild = rightAscendant;
   ...
   public void leftRotationOfRoot() {
       ...
       //grab key nodes
       BinaryTreeNode oldRoot = rootNode;
       BinaryTreeNode newRoot = oldRoot.rightChild;
       BinaryTreeNode leftAscendant = newRoot.leftChild;
       
       //sever the links
       oldRoot.rightChild = null;
       newRoot.leftChild = null;
       
       //rotate to left (re-connect the links)
       rootNode = newRoot;
       oldRoot.rightChild = leftAscendant;
   ...
   {  // create the binary search tree
       ...
       tree.leftRotationOfRoot();
       tree.leftRotationOfRoot();
       System.out.println("rotated left twice Tree: " + tree);
   }
   ...
   protected class BinaryTreeNode
   {
      ...
      {  String output = "[";
         if (leftChild!=null)
            output += "" + leftChild;
         if (this.element.equals(rootNode.element)) {
             output += "ROOT:" + element;
         } else {
             output += "" + element;
         }
